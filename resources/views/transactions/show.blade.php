    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input class="form-control @error('kategori') is-invalid @enderror" type="text" name="kategori" id="kategori" value="{{ old('kategori') ?? $transaction->kategori }}" disabled />
                    @error('kategori')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input class="form-control @error('nominal') is-invalid @enderror" type="number" name="nominal" id="nominal" min="0" value="{{ old('nominal') ?? $transaction->nominal }}" disabled />
                    @error('nominal')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input class="form-control @error('tujuan') is-invalid @enderror" type="text" name="tujuan" id="tujuan" value="{{ old('tujuan') ?? $transaction->tujuan }}" disabled />
                    @error('tujuan')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
