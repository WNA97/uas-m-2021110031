...
<div class="page-title-box">
    ...
    <ol class="breadcrumb">
        <li class="breadcrumb-item">
            <a href="{{ route('dashboard') }}">2021110031</a>
        </li>
        <li class="breadcrumb-item">
    ...
    {{-- <div class="state-information d-none d-sm-block">
        <div class="dropdown pt-3 d-inline-block">
            <a class="btn btn-warning waves-effect waves-light" href="{{ route('transactions.create') }}" role="button">
    Create New
    </a>
</div>
</div> --}}
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <form action="{{ route('transactions.destroy', $transaction->id) }}" method="POST">
                                                    @csrf @method('DELETE')
                                                    <button onclick="return confirm('Apa anda yakin akan menghapus data {{ $transaction->nama }}?')" type="submit" class="btn btn-sm btn-danger">
